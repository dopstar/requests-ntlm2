...
class TestHttpNtlmContext(unittest.TestCase):
    ...
    def test_set_challenge_from_header(self):
        ...
        self.assertEqual(
            ...
            "NTLMSSP"
            "\x00\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x002\x02\x88\xe0\x02q\xff,"
            "\xa7\xa6\xd5\xb0\x00\x00\x00\x00\x00\x00\x00\x00~\x00~\x008\x00\x00\x00\x05\x00"
            "\x93\x08\x00\x00\x00\x0f\x02\x00\x0c\x00D\x00E\x00T\x00N\x00S\x00W\x00\x01\x00"
            "\x1a\x00S\x00G\x00-\x000\x002\x001\x004\x003\x000\x000\x000\x001\x005\x00\x04\x00"
            "\x14\x00D\x00E\x00T\x00N\x00S\x00W\x00.\x00W\x00I\x00N\x00\x03\x000\x00s\x00g\x00"
            "-\x000\x002\x001\x004\x003\x000\x000\x000\x001\x005\x00.\x00d\x00e\x00t\x00n\x00s"
            "\x00w\x00.\x00w\x00i\x00n\x00\x00\x00\x00\x00"
        )
